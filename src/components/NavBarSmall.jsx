    ...
    <>
      ...
      >
        ...
        <span
          className={`${
            visible ? "hidden" : ""
          } inline-block w-8 h-1 bg-gray-700`}
        ></span>
        <span
          className={`${
            visible ? "hidden" : ""
      ...
      <ul
        className={`${
          !visible ? "hidden" : ""
        } absolute top-0 right-0 w-full text-center pt-12 pb-5 bg-white text-red-500 md:hidden space-y-2 uppercase shadow-md rounded-md z-10`}
      >
